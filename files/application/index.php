    ...
    <nav class="navbar navbar-default navbar-pf" role="navigation">
      ...
      <div class="collapse navbar-collapse navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-primary">
          <li class="active">
            <a href="info.php" class="active">Server Information</a>
          </li>
        </ul>
      </div>
    </nav>
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          ...
          <h1>Welcome to the TEST Blue/Green Application!</h1>
          <p>The purpose of this application is to demonstrate Blue/Green Deployments. We hope you enjoy it!</p>
        </div>
      </div>
      <div class="row">
